...
public interface TextFilesRepository extends BaseTable implements TableOperations{
    public TextFilesRepository() throws SQLException {
        super("TextFilesRepository");
    }
